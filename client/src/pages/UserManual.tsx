...
const SECTIONS = [
  ...
  },
  {
    ...
    content: [
      ...
      { heading: "Eliminar un colaborador", text: "Haz clic en el ícono de papelera (🗑) en la tarjeta. Aparece un modal de confirmación advirtiendo que la acción es permanente. Al confirmar, el colaborador se elimina por completo del sistema.\n\nNota: si el colaborador tiene registros de asistencia o tiempo extra, el sistema no permitirá la eliminación y mostrará un mensaje de error. En ese caso, usa «Dar de baja» en su lugar." },
    ],
  },
  {
    id: "agregar",
